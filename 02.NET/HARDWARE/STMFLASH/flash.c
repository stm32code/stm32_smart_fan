...
void W_Test(void)
{
    ...
    System_WriteInteriorFlash(addrShort1, (uint8_t *)&turn_init.Turn_Num, sizeof(turn_init.Turn_Num)); // 存入数据，函数内自动解锁，擦除，写入
	//	System_WriteInteriorFlash(addrShort2, (uint8_t *)&device_state_init.tiem, sizeof(device_state_init.tiem)); // 存入数据，函数内自动解锁，擦除，写入
...
void R_Test(void)
{
    ...
    System_ReadInteriorFlash(addrShort1, (uint8_t *)&turn_init.Turn_Num, sizeof(turn_init.Turn_Num)); // 读取数据，函数内自动按半字读取
	//	System_ReadInteriorFlash(addrShort2, (uint8_t *)&device_state_init.tiem, sizeof(device_state_init.tiem)); // 存入数据，函数内自动解锁，擦除，写入
